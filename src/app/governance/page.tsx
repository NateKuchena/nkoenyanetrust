...
function BFSCompliance() {
  const criteria = [
    { criterion: 'South African citizen / registered entity', status: '✓ Compliant' },
    { criterion: '100% Black-owned and managed', status: '✓ Compliant' },
    { criterion: 'Priority BFS agricultural sector', status: '✓ Compliant' },
    { criterion: '10% farm worker profit sharing', status: '✓ Compliant' },
    { criterion: 'No prior government funding mismanagement', status: '✓ Compliant' },
    { criterion: 'Full-time producer', status: '✓ Compliant' },
    { criterion: 'No distressed debt at application', status: '✓ Compliant' },
    { criterion: 'Scorecard minimum 20/50', status: '✓ Est. 46/50' },
  ];
