...
function PageHero() {
  return (
    ...
    >
      ...
      <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(180deg,rgba(0,0,0,0.15) 0%,rgba(0,0,0,0.55) 60%,rgba(0,0,0,0.78) 100%)' }} />
    ...
    <section className="section-pad">
      <div className="container">
        <div className="story-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'clamp(48px,7vw,112px)', alignItems: 'center' }}>
          ...
          <ImagePlaceholder caption="img · free state farmland · golden hour · 1200×900" height={460} />
        </div>
      </div>
...
function EthosSection() {
  const values = [
    { icon: '◆', title: 'Innovation', body: 'Embedding 4IR technology — IoT, automation, data analytics — into every operational zone.' },
    { icon: '◆', title: 'Integrity', body: 'Institutional governance, audited financials, and full transparency with every investor and partner.' },
    { icon: '◆', title: 'Sustainability', body: 'Regenerative land use, rotational grazing, and precision agriculture for long-term soil health.' },
    { icon: '◆', title: 'Empowerment', body: '10% profit sharing for all permanent staff. Priority hiring: women, youth, local community.' },
  ];
